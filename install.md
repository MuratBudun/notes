...
SMTP_MAIL_FROM_NAME="YOUR_SMTP_MAIL_FROM_NAME"
SMTP_MAIL_FROM_EMAIL="YOUR_SMTP_MAIL_FROM_EMAIL"
...
kubectl create secret generic qmex-forms-app-config \
    ...
    --from-literal=SMTP_MAIL_FROM_NAME="$SMTP_MAIL_FROM_NAME" \
    --from-literal=SMTP_MAIL_FROM_EMAIL="$SMTP_MAIL_FROM_EMAIL" \
